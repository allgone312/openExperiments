<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="exercise20170703.Update" %>
...
<head runat="server">
    ...
    <title>学生档案管理系统-1505211-18-韩宇-修改</title>
                        ...
                        <li class="tpl-left-nav-item">
                            ...
                            <ul class="tpl-left-nav-sub-menu" style="display:block;">
                                <li>
                                    ...
                                    <a href="Update.aspx" class="active">
                                        <i class="am-icon-angle-right"></i>
                                        <span>修改学生档案</span>
                                        <i class="tpl-left-nav-content-ico am-fr am-margin-right"></i>
                                    </a>
                                ...
                                <div class="am-form tpl-form-line-form">
                                    ...
                                    <div class="am-form-group">
                                        <div class="am-u-sm-9 am-u-sm-push-3">
                                            <button runat="server" id="btn_sub" onserverclick="btn_sub_ServerClick" class="am-btn am-btn-primary tpl-btn-bg-color-success ">修改</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
