<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Insert.aspx.cs" Inherits="exercise20170703.Insert" %>
...
<head runat="server">
    ...
    <title>学生档案管理系统-1505211-18-韩宇-插入</title>
    ...
    <header class="am-topbar am-topbar-inverse admin-header">
                    ...
                    <ul class="tpl-left-nav-menu">
                        ...
                        <li class="tpl-left-nav-item">
                            ...
                            <ul class="tpl-left-nav-sub-menu"  style="display:block;">
                                <li>
                                    <a href="Insert.aspx" class="active">
        ...
        <div class="tpl-content-wrapper">
            <ol class="am-breadcrumb">
                ...
                <li class="am-active">新增学生档案</li>
            </ol>
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 必填信息
                    </div>
                </div>
                <div class="tpl-block">
                    <div class="am-g">
                        <div class="tpl-form-body tpl-form-line">
                            <div class="am-form tpl-form-line-form">
                                ...
                                <div class="am-form-group">
                                    <label for="user-email" class="am-u-sm-3 am-form-label">入学时间
                                ...
                                <div class="am-form-group">
                                    <label for="user-email" class="am-u-sm-3 am-form-label">出生年月
                                ...
                                <div class="am-form-group">
                                    <label class="am-u-sm-3 am-form-label">身份证号 
                                ...
                                <div class="am-form-group">
                                    <label for="user-phone" class="am-u-sm-3 am-form-label">民族
                                ...
                                <div class="am-form-group">
                                    <label for="user-weibo" class="am-u-sm-3 am-form-label">籍贯
                                ...
                                <div class="am-form-group">
                                    <label for="user-phone" class="am-u-sm-3 am-form-label">所学专业 
                ...
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 选填信息
                    </div>
                </div>
                <div class="tpl-block">
                    <div class="am-g">
                        <div class="tpl-form-body tpl-form-line">
                            <div class="am-form tpl-form-line-form">
                                ...
                                <div class="am-form-group">
                                    <label for="address" class="am-u-sm-3 am-form-label">家庭住址
                                ...
                                <div class="am-form-group">
                                    <div class="am-u-sm-9 am-u-sm-push-3">
                                        <button runat="server" id="btn_sub" onserverclick="btn_sub_ServerClick"  class="am-btn am-btn-primary tpl-btn-bg-color-success ">提交</button>
                                    </div>
                                </div>
                        </div>
                    </div>
